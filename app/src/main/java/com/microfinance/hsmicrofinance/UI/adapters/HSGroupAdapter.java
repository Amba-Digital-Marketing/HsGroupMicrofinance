...
public class HSGroupAdapter extends  RecyclerView.Adapter<HSGroupAdapter.TRXHolder>  {
    ...
    public HSGroupAdapter(Context context, List<TransactionHistory.TransactionHistoryDetail>transactionHistoryDetails, LatestTransactionInterface latestTransactionInterface) {
