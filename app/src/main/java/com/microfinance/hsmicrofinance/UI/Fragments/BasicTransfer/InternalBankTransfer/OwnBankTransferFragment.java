...
import com.microfinance.hsmicrofinance.databinding.FragmentOwnBankTransferBinding;
...
public class OwnBankTransferFragment extends Fragment {
    ...
    FragmentOwnBankTransferBinding mFragmentPayFriendsViaMpesaBinding;
    ...
    public OwnBankTransferFragment(String phone, String phoneOnHs) {
        this.phone =phone;
        this.phoneOnHs = phoneOnHs;
        // Required empty public constructor
    }

    public OwnBankTransferFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFragmentPayFriendsViaMpesaBinding = FragmentOwnBankTransferBinding.inflate(inflater, container, false);
...
//        }
    ...
    @RequiresApi(api = Build.VERSION_CODES.N)
    private void doPayForFriend(View view,FragmentOwnBankTransferBinding binding) {
        ...
        if (mFragmentPayFriendsViaMpesaBinding.choosePhoneNumber.getText().toString().isEmpty()) {
            ...
            try {
                ...
                viewModel.transferToHSAccountBanks(getContext(), mFragmentPayFriendsViaMpesaBinding.choosePhoneNumber.getText().toString().trim(), (int)Double.parseDouble(mFragmentPayFriendsViaMpesaBinding.enterAmount.getText().toString().trim()));
                viewModel.mOtherBankTransferMutableLiveData.observe(getViewLifecycleOwner(), internalTransferResponse ->{
                    if(internalTransferResponse != null){
                        if(internalTransferResponse.transferInformation != null){
                            mNavController.navigate(R.id.action_transferFundsFragment_to_internalTransferOtpFragment);
                        }
                    }
                });
            } catch (Exception e) {
    ...
    public void addContacts () {
        ...
        try {
            ...
            bundle.putString("FRAGMENT","BANKTRANSFER");
            mNavController.navigate(R.id.action_transferFundsFragment_to_contacts,bundle);
