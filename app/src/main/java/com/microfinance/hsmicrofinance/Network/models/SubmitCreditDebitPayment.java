...
public class SubmitCreditDebitPayment {
    @SerializedName("0")
    @Expose
    public String _0;
    ...
    public class EnteringTransactionDetailsInDepositTable {
        ...
        public EnteringTransactionDetailsInDepositTable() {
        }

        public EnteringTransactionDetailsInDepositTable(String trx, Integer userId, String getwayId, String type, Double amount, Double charge, Integer status, String updatedAt, String createdAt, Integer id) {
            this.trx = trx;
            this.userId = userId;
